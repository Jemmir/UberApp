...
const HomeScreen = ({navigation}) => {
    ...
    const checkPermission = async () => {
        const hasPermision = await Location.requestForegroundPermissionsAsync();
        if(hasPermision.status === "granted") {
      ...
      <ScrollView bounces={false}> 
        <View style={styles.home}>
             ...
             <View style={styles.view1}>
                <View style={styles.view8}>
                    <Text style={styles.text2}>Read a book. Take a Snap. Stare out the window</Text>
        ...
        <View>
                <FlatList 
                    numRows={4}
                    horizontal={true}
                    showsHorizontalSchollIndicator={false} 
                    data={filterData}
